...
import { filterGuestSafeContent, showGuestActionPrompt } from "./nullverse-guest.js?v=20260821";
...
function setupControls() {
    ...
    ["explore-sort", "explore-rating", "explore-genre", "explore-creator-filter"].forEach(id => {
        document.getElementById(id).addEventListener("change", () => {
            ...
            if (isGuest && ["adult", "18+", "18_plus"].includes(String(state.rating).toLowerCase())) {
                state.rating = "";
                document.getElementById("explore-rating").value = "";
                showGuestActionPrompt("view 18+ material");
            }
