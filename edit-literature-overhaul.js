(() => {
    ...
    const RAIL_STATE_KEY = "nullverse-literature-editor-rail-collapsed-v1";
    ...
    function buildSidebar(sidebar) {
        ...
        if (header && !header.querySelector(".nv-literature-rail-topline")) {
            ...
            topLine.innerHTML = `
                ...
                <button class="nv-literature-rail-close" type="button" aria-label="Collapse chapter outline" title="Collapse chapter outline">‹</button>
            `;
    ...
    function enforceFocusedStudioIsolation(active) {
        ...
        if (active) {
            ...
            document.querySelectorAll(".nv-literature-sidebar-backdrop, .nv-literature-mobile-outline").forEach(element => {
