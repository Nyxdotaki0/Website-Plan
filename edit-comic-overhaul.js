(() => {
    ...
    const RAIL_STATE_KEY = "nullverse-comic-editor-rail-collapsed-v1";
    ...
    function buildSidebar(sidebar) {
        ...
        if (header && !header.querySelector(".nv-comic-rail-topline")) {
            ...
            topLine.innerHTML = `
                ...
                <button class="nv-comic-rail-close" type="button" aria-label="Collapse chapter outline" title="Collapse chapter outline">‹</button>
            `;
    ...
    const PRIMARY_STUDIO_SELECTOR = ".page-studio-overlay";
    ...
    function installStudioLifecycleWrappers() {
        ['openPageStudio', 'openImagePlacementStudioForKey', 'openImagePlacementStudioForPage', 'closePageStudio', 'closeImagePlacementStudio'].forEach(wrapStudioLifecycleFunction);
    }
