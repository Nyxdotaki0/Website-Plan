(() => {
    ...
    function focusedStudioIsOpen() {
        if (document.body.classList.contains("page-studio-active")) return true;
    ...
    function enforceFocusedStudioIsolation(active) {
        ...
        if (active) {
            ...
            document.querySelectorAll(".nv-comic-sidebar-backdrop, .nv-comic-mobile-outline").forEach(element => {
